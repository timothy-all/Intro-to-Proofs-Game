...
Introduction "## **Level 3 : Composing functions**

Let's prove that the compositum of two functions is a function.

### **💡 Pro-tip**
Forgot how the compositum works? It's called `REL: ∘` in your inventory!"
...
Conclusion "While it's always possible to unpack `isFunction f` without using `evaluate`, it feels awkward and doesn't match how we write proofs in English."
